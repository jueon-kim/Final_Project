		...
		<div class="card bg-light mt-3">
			<div class="card-header bg-light">
				<div class="row">
					...
					종합<span style="color: red;">A</span></div>
				</div>
			</div>
			<div class="card-body">
				<h5 class="card-title">
		...
		<div class="card bg-light mt-3">
			<div class="card-header bg-light">
				<div class="row">
					...
					<div class="col-4 text-right">
					종합<span style="color: red;">B</span></div>
				</div>
			</div>
			<div class="card-body">
				<h5 class="card-title">
				...
				<div class="modal-body">
					<form action="./evaluationRegisterAction.jsp" method="post">
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-secondary mx-1 mt-2" data-bs-dismiss="modal">취소</button>
							<button type="submit" class="btn btn-primary mx-1 mt-2">등록하기</button>
						</div>
					</form>
				</div>
			</div>
	...
	<div class="modal fade" id="reportModal" tabindex="-1" role="dialog" aria-labelledby="modal" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary mx-1 mt-2" data-bs-dismiss="modal">취소</button>
					<button type="submit" class="btn btn-danger mx-1 mt-2">신고하기</button>
				</div>
			</div>
		</div>
	</div>
